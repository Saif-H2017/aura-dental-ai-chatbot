...
• <strong>Clinic Location</strong>: 72 Harley Street, London W1G 7HG<br><br>

<a href="${gcalUrl}" target="_blank" style="display:inline-flex; align-items:center; gap:8px; margin-top:4px; padding:12px 20px; background:#4285F4; color:#FFFFFF; font-weight:800; border-radius:10px; text-decoration:none; box-shadow:0 4px 14px rgba(66,133,244,0.35); font-size: 0.95rem;">
